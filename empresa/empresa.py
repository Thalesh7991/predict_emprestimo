...
class PredictEmprestimo(object):
    def __init__(self):
        self.home_path = ''
        self.finalidade_emprestimo_encoding                     = pickle.load(open(self.home_path + 'parameter/finalidade_emprestimo_encoding.pkl', 'rb'))
        self.grau_risco_emprestimo_encoding                     = pickle.load(open(self.home_path + 'parameter/grau_risco_emprestimo_encoding.pkl', 'rb'))
        self.posse_casa_encoding                                = pickle.load(open(self.home_path + 'parameter/posse_casa_encoding.pkl', 'rb'))
        self.historico_credito_scaler                           = pickle.load(open(self.home_path + 'parameter/historico_credito_scaler.pkl', 'rb'))
        self.idade_scaler                                       = pickle.load(open(self.home_path + 'parameter/idade_scaler.pkl', 'rb'))
        self.proporcao_emprestimo_historico_credito_scaler      = pickle.load(open(self.home_path + 'parameter/proporcao_emprestimo_historico_credito_scaler.pkl', 'rb'))
        self.proporcao_emprestimo_idade_scaler                  = pickle.load(open(self.home_path + 'parameter/proporcao_emprestimo_idade_scaler.pkl', 'rb'))
        self.proporcao_emprestimo_tempo_emprego_scaler          = pickle.load(open(self.home_path + 'parameter/proporcao_emprestimo_tempo_emprego_scaler.pkl', 'rb'))
        self.proporcao_renda_emprestimo_scaler                  = pickle.load(open(self.home_path + 'parameter/proporcao_renda_emprestimo_scaler.pkl', 'rb'))
        self.relacao_emprestimo_renda_scaler                    = pickle.load(open(self.home_path + 'parameter/relacao_emprestimo_renda_scaler.pkl', 'rb'))
        self.renda_scaler                                       = pickle.load(open(self.home_path + 'parameter/renda_scaler.pkl', 'rb'))
        self.taxa_juros_ajustada_renda_scaler                   = pickle.load(open(self.home_path + 'parameter/taxa_juros_ajustada_renda_scaler.pkl', 'rb'))
        self.taxa_juros_emprestimo_scaler                       = pickle.load(open(self.home_path + 'parameter/taxa_juros_emprestimo_scaler.pkl', 'rb'))
        self.tempo_emprego_scaler                               = pickle.load(open(self.home_path + 'parameter/tempo_emprego_scaler.pkl', 'rb'))
        self.valor_emprestimo_scaler                            = pickle.load(open(self.home_path + 'parameter/valor_emprestimo_scaler.pkl', 'rb'))
        self.imputer                                            = pickle.load(open(self.home_path + 'parameter/imputer_knn.pkl', 'rb'))
